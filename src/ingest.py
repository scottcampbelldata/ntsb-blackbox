...
from paths import DB_PATH as DB, DOCS_DIR as DOCS, RAW_PATH as RAW
...
def _require_raw_csv():
    if RAW.exists():
        return
    raise FileNotFoundError(
        f"Missing source CSV: {RAW}\n"
        "Download final_reports_2016-23_cons_2024-12-24.csv from Zenodo "
        "record 17096333 into data/raw/, then run this script again."
    )
